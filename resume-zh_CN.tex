...
\begin{itemize}[parsep=0.5ex]
  \item 参与 AI PaaS 平台的研发，构建了一个集成算力、算法、智能体管理的统一平台，实现云、边、端的算法统一调度和部署，降低了推理系统的复杂性，提高了推理平台的扩展性。
  \item AI Paas Gateway 为\textbf{智能体}提供会话管理、历史消息管理功能，支持多种智能体的接入，提供统一的 API 服务。
  \item 支持多种\textbf{大模型}的托管和推理，基于 vLLM 优化推理流程，并通过 AI PaaS Gateway 提供 OpenAI API 代理，实现高效的模型推理服务，使智能体能够流畅调用，提升对话质量和并发能力。
  \item 支撑各个BG的业务场景，推动大模型和智能体技术落地，提升了用户体验和智能化水平。
\end{itemize}
